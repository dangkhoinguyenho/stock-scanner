...
| 1 | Data pipeline (market data, news, SEC filings, economic calendar, company events, options data — all timestamped) | In progress — 4/5 collectors done (market data, SEC filings, economic calendar, news); options data remaining |
